...
@section('title', 'Wiggler - Edit event')
...
<div class="col-xxl">
    <div class="card mb-4">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">Edit event</h5> <small class="text-muted float-end">Please fill the inputs below</small>
      </div>
      <div class="card-body">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" value="{{ old('description', $event->description) }}" name="description" id="description"/>
              </div>
            </div>
          </div>
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <span id="basic-icon-default-message2" class="input-group-text"><i class="bx bx-time-five"></i></span>
                <input type="datetime-local" class="form-control" value="{{ old('dateDeb', $event->dateDeb) }}" name="dateDeb" id="dateDeb"/>
              </div>
            </div>
          </div>
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <span id="basic-icon-default-message2" class="input-group-text"><i class="bx bx-time-five"></i></span>
                <input type="datetime-local" class="form-control" value="{{ old('dateFin', $event->dateFin) }}" name="dateFin" id="dateFin"/>
              </div>
            </div>
          </div>
          <div class="row mb-3">
            ...
            <select class="form-select" id="association_id" name="association_id">
                                      @foreach($associations as $association)
                                        <selected option="{{ $event->association_id }}">
