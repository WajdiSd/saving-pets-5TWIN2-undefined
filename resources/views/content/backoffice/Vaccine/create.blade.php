...
@section('title', 'Wiggler - Add vaccine')

@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Vaccine/</span> Add</h4>
<div class="row">
<div class="col-xxl">
    <div class="card mb-4">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">Add vaccine</h5> <small class="text-muted float-end">Please fill the inputs below</small>
      </div>
      <div class="card-body">
        ...
        @csrf
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="text" class="form-control" placeholder="Vaccine name" name="name" id="name"/>
              </div>
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input type="number" class="form-control"  name="quantity" id="quantity"/>              </div>
            </div>
          </div>
          <div class="row mb-3">
            <label class="col-sm-2 form-label" for="basic-icon-default-message"></label>
          ...
          <div class="row mb-3">
            <label for="typevaccine" class="form-label">Type Vaccine</label>
            <select class="form-select" id="typevaccine" aria-label="Default select example" name="type_vaccine_id">
              @foreach($typevaccines as $vaccine)
          ...
          <div class="row justify-content-end">
            <div class="col-sm-10">
              <button type="submit" class="btn btn-outline-success">Add vaccine</button>
            </div>
          </div>
        </form>
      </div>
