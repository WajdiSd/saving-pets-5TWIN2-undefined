...
class RewardController extends Controller
{
  ...
  {
    $types = TypeReward::all();
    return view('content.backoffice.reward.create-reward', compact('types'));
  }
  ...
  public function store(Request $request)
  {
    ...
    $reward->type_rewards_id = $request->input('typeReward');
    $reward->save();
  ...
  public function update(Request $request, Reward $reward)
  {
    ...
    return redirect('backoffice/rewards')->with('success', 'Reward Updated');
  }
}
